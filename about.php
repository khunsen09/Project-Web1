      ...
      <div class="container-fluid position-relative d-flex align-items-center justify-content-end" style="margin-left: 10px;">
        ...
        <nav id="navmenu" class="navmenu" style="margin: 0 auto;">
          <ul>
            ...
            <li><a href="about.php" class="active" style="font-size: 15px;">About</a></li>
  ...
  <div class="container">
    ...
    <div class="row gy-4">
      <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
        ...
        <a href="https://metroiloilohospital.com/vid/mm.mp4#t=02" class="glightbox pulsating-play-btn"></a>
      </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="swiper init-swiper">
        ...
        <div class="swiper-wrapper align-items-center">
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/archi.png"><img src="Images/archi.png" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/area.png"><img src="Images/area.png" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/bldg.png"><img src="Images/bldg.png" class="img-fluid" alt=""></a></div>
          <!-- <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/cons.png"><img src="Images/cons.png" class="img-fluid" alt=""></a></div> -->
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/ccd.png"><img src="Images/ccd.png" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/cp.png"><img src="Images/cp.png" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/gbc.png"><img src="Images/gbc.png" class="img-fluid" alt=""></a></div>
          <!-- <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/RC.png"><img src="Images/RC.png" class="img-fluid" alt=""></a></div> -->
          <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="Images/sp.png"><img src="Images/sp.png" class="img-fluid" alt=""></a></div>
...
<div class="row">
<div class="col">
  <h2 style="background-color: rgb(27, 64, 128);" class="text-white"> E. CONSTRUCTION PHASE</h2>
  <div class="container" data-aos="fade-up" data-aos-delay="500">
...
<div class="container mb-5">
  <div class="row mb-8 justify-content-center">
    <div class="col-lg-6 col-md-12 col-12 text-center">
      ...
      <h2 class="mb-2 display-4 fw-bold ">Testimonials</h2>
    </div>
  </div>
    ...
    <div class="col-md-6 col-12 mb-4 mb-lg-0">
      ...
      <div class="card shadow-lg">
        ...
        <div class="card-body p-4 p-md-8 text-center">
          ...
          <p class="text-dark mt-3" style="font-size: 18px;">Good morning, friends and colleagues! Today marks another milestone in our journey to a more progressive and fruitful administration of our beloved Metro Iloilo Hospital and Medical Center, Inc.</p>
          <p class="text-dark mt-3" style="font-size: 18px;">In today’s modern world, the maintenance of a corporate website is indispensable. With information at our fingertips, our online presence translates to client convenience. It is through our website that our customers are able to find us 24/7, anytime, anywhere.</p>
          <p class="text-dark mt-3" style="font-size: 18px;">In our bid to be more progressive, through the creation of our new website, we hope to achieve the following:</p>
          <p class="text-dark mt-3" style="font-size: 18px;">Firstly, we hope to improve our traffic by providing our clients with an easier way of communicating to us by adding functionality and a more integrated and user-friendly interface;</p>
          <p class="text-dark mt-3" style="font-size: 18px;">Secondly, we aim to improve our credibility with our new design. A good-quality, easy-to-use website would surely make our clients feel more comfortable using our service. The aim is for our clients to assume that they can expect that same positive experience through our actual care when they are physically within our premises; and</p>
          <p class="text-dark mt-3" style="font-size: 18px;">Finally, in general, we hope to provide a place that potential clients and stakeholders can be referred to. It will show what our hospital is about, what is has achieved, and what it can achieve in the future.</p>
          <p class="text-dark mt-3" style="font-size: 18px;">I hope that we all continue to support these types of initiatives for a more successful Metro Iloilo Hospital and Medical Center, Inc. Thank you and stay safe always!</p>
    ...
    <div class="col-md-6 col-12">
      ...
      <div class="card shadow-lg">
        <div class="card-body p-4 p-md-8 text-center">
          ...
          <p class="text-dark mt-3" style="font-size: 18px;">It is with great pride and honor that I stand before you today on this momentous occasion. Today marks the realization of our dream of building a hospital. We have toiled a lot, spent sleepless nights with untiring efforts for the last three years in order to come up with what we have now.</p>
          <p class="text-dark mt-3" style="font-size: 18px;">I would like to recognize the efforts shared by my fellow core members as well as the support from our investors without which this dream would not be realized. the momentum is now with us, the process of building will continue, the pursuit for success still lies ahead. We have just begun, and we will strive further. Together we must work unmindful of personal gains, for a common good, for the good of this hospital.</p>
          <p class="text-dark mt-3" style="font-size: 18px;">So i encourage my fellow Founders, that we must do our part in making this hospital as the shining glory of our efforts for ourselves, our family, our community and most of all for the God Almighty.</p>
          <!-- More testimonial text here -->
        </div>
        <!-- Card Footer -->
        <div class="card-footer bg-primary text-center border-top-0">
