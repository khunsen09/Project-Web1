	...
	<div class="container">
        ...
        <a href="../packages.php" class="btn btn-primary rounded-pill py-md-3 px-md-5 mx-2">Packages</a>
			...
			<div class="col-md-6 offset-md-1 my-3">
				<p class="lead">Our Emergency Room is open 24/7, providing immediate, life-saving care to patients in critical situations. Staffed by a dedicated team of emergency physicians, nurses, and specialists, our ER is equipped with cutting-edge technology to handle a wide range of medical emergencies, from trauma and cardiac events to pediatric and adult urgent care needs.</p>
				<p class="lead">We prioritize rapid assessment, diagnosis, and treatment to ensure the best possible outcomes. With a compassionate approach and a focus on patient safety, our Emergency Room is your trusted partner in times of urgent medical</p>
			</div>
		</div>
	</div>
</section>
