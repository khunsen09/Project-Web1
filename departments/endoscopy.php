...
<div class="container section-title" data-aos="fade-up">
  <h2 class="text-center mt-5">Endoscopy Unit</h2>
  <p class="title-paragraph text-center mt-4" style="font-size: 25px; font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Advanced diagnostic and therapeutic procedures for gastrointestinal health.</p>
...
<div class="container my-3">
  ...
  <div class="row justify-content-center my-5">
    <!-- Card for Bronchoscopy -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Bronchoscopy</h5>
          <p class="card-text">A procedure to examine the inside of the lungs and airways.</p>
        </div>
      </div>
    </div>

    <!-- Card for Colonoscopy -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Colonoscopy</h5>
          <p class="card-text">A diagnostic procedure to examine the colon and rectum.</p>
        </div>
      </div>
    </div>

    <!-- Card for Intra Operative Cardiac Monitoring -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Intra Operative Cardiac Monitoring</h5>
          <p class="card-text">Real-time cardiac monitoring during surgeries.</p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">ERCP</h5>
          <p class="card-text">Endoscopic procedure to examine bile and pancreatic ducts.</p>
        </div>
      </div>
    </div>

    <!-- Card for Flexible Sigmoidoscopy -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Flexible Sigmoidoscopy</h5>
          <p class="card-text">A minimally invasive procedure to examine the rectum and sigmoid colon.</p>
        </div>
      </div>
    </div>

    <!-- Card for Laryngoscopy -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Laryngoscopy</h5>
          <p class="card-text">A procedure to examine the voice box and throat.</p>
        </div>
      </div>
    </div>

    <!-- Card for Polypectomy -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Polypectomy</h5>
          <p class="card-text">Removal of polyps from the colon or other areas.</p>
        </div>
      </div>
    </div>

    <!-- Card for Rapid Urease Strip -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Rapid Urease Strip</h5>
          <p class="card-text">A diagnostic test for Helicobacter pylori infections.</p>
        </div>
      </div>
    </div>

    <!-- Card for Rubber Band Ligation -->
    <div class="col-md-4 mb-4">
      <div class="card shadow-sm h-100">
        <div class="card-body">
          <h5 class="card-title">Rubber Band Ligation</h5>
          <p class="card-text">A treatment for hemorrhoids using rubber bands to cut off blood flow.</p>
        </div>
      </div>
    </div>
  </div>
...
<div class="container my-5">
  <div class="row gallery">
    <!-- Column 1 -->
    <div class="col-md-6">
      <img src="../Images/endoscopy-1.jpg" alt="Image 1" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
    <!-- Column 2 -->
    <div class="col-md-6">
      <img src="../Images/endoscopy-2.jpg" alt="Image 2" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
  </div>
</div>
...
<div class="container my-5">
  <div class="row gallery">
    <!-- Column 1 -->
    <div class="col-md-4">
      <img src="../Images/endoscopy-4.jpg" alt="Image 1" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
    <!-- Column 2 -->
    <div class="col-md-4">
      <img src="../Images/endoscopy-5.jpg" alt="Image 2" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
    <!-- Column 3 -->
    <div class="col-md-4">
      <img src="../Images/endoscopy-8.jpg" alt="Image 3" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
  </div>
</div>
...
<div class="container my-5">
  <div class="row gallery">
    <!-- Column 1 -->
    <div class="col-md-6">
      <img src="../Images/endoscopy-9.jpg" alt="Image 1" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
    <!-- Column 2 -->
    <div class="col-md-6">
      <img src="../Images/endoscopy-3.jpg" alt="Image 3" class="img-thumbnail" onclick="openModal(this.src)">
    </div>
  </div>
</div>
