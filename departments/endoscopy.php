  ...
  <header id="header" class="header sticky-top" style="background-color: rgb(27, 64, 128);">
    <div class="branding d-flex align-items-center">
      ...
      <div class="container-fluid position-relative d-flex align-items-center justify-content-end" style="margin-left: 10px;">
        ...
        <!-- Search Form -->
        <form class="d-flex ms-3" action="results.php" method="get" role="search">
...
<div class="container section-title" data-aos="fade-up">
  ...
  <div class="px-4 mt-5">
    ...
    <h2 class="mb-5 text-center" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Services Offered:</h2>
    <div class="container">
        <div class="row">
          <div class="col-sm">
            <ul  style="font-size: 25px;">
                <li>Bronchoscopy</li>
                <li>Colonoscopy</li>
                <li>Intra Operative Cardiac Monitoring</li>
                <li>ERCP</li>
            </ul>
          </div>
